...
public class ParticipantInsideEvent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_participant_inside_event);
...
//        Toast.makeText(this, getIntent().getStringExtra("evid"), Toast.LENGTH_SHORT).show();
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(ParticipantInsideEvent.this,ParticipantAssignedWork.class).putExtra("eid",id));
            }
        });
    }
}
